...
const BASE_PROVIDERS = {
  ...
  'gpt-image2-vip': {
    ...
    referenceHelpText: '支持文生图和最多 3 张参考图的图生图。多张大图可能受上游上传体积限制。',
    backendKind: 'gpt-image2-vip',
  },
  'gpt-image2-2': {
    id: 'gpt-image2-2',
    typeId: 'image',
    typeLabel: 'Image',
    selectorLabel: 'gpt image2(2)',
    name: 'gpt image2(2)',
    vendor: 'Kie.ai',
    color: '#2563eb',
    outputType: 'image',
  ...
  'fal-gpt-image2-medium': {
    id: 'fal-gpt-image2-medium',
    typeId: 'image',
    typeLabel: 'Image',
    selectorLabel: 'gpt image2(Medium)',
    name: 'gpt image2(Medium)',
    vendor: 'fal.ai',
    color: '#0f766e',
    outputType: 'image',
    models: [
      { value: 'openai/gpt-image-2', label: 'gpt image2(Medium)', tag: 'Medium' },
    ],
    aspectRatios: ['1:1', '3:4', '9:16', '16:9'],
    resolutions: { default: ['1920x1920', '1440x1920', '1080x1920', '1920x1080'] },
    hideResolutionSelector: true,
    resolutionByAspectRatio: {
      '1:1': '1920x1920',
      '3:4': '1440x1920',
    ...
    referenceHelpText: 'fal.ai GPT Image 2，质量固定为 Medium；支持文生图和最多 16 张参考图的图生图。',
    backendKind: 'fal-gpt-image2',
  },
  ...
  'claude1-copywriting': {
    id: 'claude1-copywriting',
    typeId: 'copywriting',
    typeLabel: '文案模型',
    selectorLabel: 'claude1',
